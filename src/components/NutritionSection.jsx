  ...
  return (
    <section className="nutrition-section">
      ...
      <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0">
        ...
        <div className="flex md:justify-center items-center tranlate-y-5">
            <div className="md:max-w-xs max-w-md">
                <p className="text-lg md:text-right text-balance font-paragraph">Milk contains a wide array of nutients, including vitamins, minerals,and protein, and this is lactose free</p>
            </div>
        </div>
